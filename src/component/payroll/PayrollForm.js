                ...
                <form action="" className="form" onSubmit={this.save}>
                    ...
                    <div className="row-content">
                        ...
                        <div className="profile-radio-content">
                            <label>
                                <input type="radio" id="profile1" name="profilePic" onChange={this.handleChange} value='../assets/profile-images/Ellipse -3.png' checked={this.state.profilePic === '../assets/profile-images/Ellipse -3.png'}></input>
